                        ...
                        using (var gzstream = new GZipStream(stream, CompressionMode.Decompress))
                        {
                            ...
                            using (var reader = new StreamReader(gzstream))
                            {
                                ...
                                var resultList = from a in rows
                                                 ...
                                                 from user in a.Descendants().Where(b => b.HasAttributes && b.Attributes["class"] != null && b.Attributes["class"].Value != null && b.Attributes["class"].Value.Equals("plain") && b.Attributes["href"] != null && b.Attributes["href"].Value.Substring(0, 5).Equals("/user")).DefaultIfEmpty(null)
